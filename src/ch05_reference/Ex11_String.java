...
public class Ex11_String {
	...
	public static void main(String[] args) {
		...
		String str4 = "문자열";
		System.out.println(str2 == str4);	//str2, str4가 가리키는 곳이 동일함
		
		Person james = new Person("제임스", 29, "프로그래머");
		Person maria = new Person("마리아", 23, "학생");
		System.out.println(james + " - 123");
		System.out.println(maria + " - 456");		// person.java의 @Override 부분 적용됨
													//(person class 의 toString() method 적용)
	}
