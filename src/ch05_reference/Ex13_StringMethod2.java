...
public class Ex13_StringMethod2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str3.replace("방가", "하이")); // 안녕? 하이하이.

		// 정규표현식 사용 가능
		String regExp = str2.replaceAll("[?.]", "*"); // ? 또는 . 를 *로 변경해라
